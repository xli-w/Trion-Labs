...
export function renderNav(state) {
  const isLanding = state.currentScreen === "landing";
  ...
  const navigation = isLanding
    ? ""
    : `
      <nav class="lab-subnav" aria-label="Lab navigation">
    ...
    <footer class="site-footer">
      ...
      <div class="footer-actions">
        ${
          isLanding
            ? ""
            : `<button class="text-button" type="button" data-action="landing">Back to introduction</button>`
        }
        ${renderThemeToggle()}
        ${
          isLanding
